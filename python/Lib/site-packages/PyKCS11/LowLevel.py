...
class CK_GCM_PARAMS(_object):
    ...
    if _newclass:pIv = _swig_property(_LowLevel.CK_GCM_PARAMS_pIv_get, _LowLevel.CK_GCM_PARAMS_pIv_set)
    ...
    if _newclass:ulIvLen = _swig_property(_LowLevel.CK_GCM_PARAMS_ulIvLen_get, _LowLevel.CK_GCM_PARAMS_ulIvLen_set)
    __swig_setmethods__["pAAD"] = _LowLevel.CK_GCM_PARAMS_pAAD_set
    __swig_getmethods__["pAAD"] = _LowLevel.CK_GCM_PARAMS_pAAD_get
    if _newclass:pAAD = _swig_property(_LowLevel.CK_GCM_PARAMS_pAAD_get, _LowLevel.CK_GCM_PARAMS_pAAD_set)
    ...
    if _newclass:ulAADLen = _swig_property(_LowLevel.CK_GCM_PARAMS_ulAADLen_get, _LowLevel.CK_GCM_PARAMS_ulAADLen_set)
    ...
    if _newclass:ulTagBits = _swig_property(_LowLevel.CK_GCM_PARAMS_ulTagBits_get, _LowLevel.CK_GCM_PARAMS_ulTagBits_set)
    def __init__(self): 
